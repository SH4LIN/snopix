	...
	theme: {
		extend: {
			colors: {
				...
				'snopix-success-deep': 'var(--snopix-success-deep)',
				'snopix-warning-deep': 'var(--snopix-warning-deep)',
				'snopix-danger-deep': 'var(--snopix-danger-deep)',
				'snopix-success-soft': 'var(--snopix-success-soft)',
				'snopix-warning-soft': 'var(--snopix-warning-soft)',
				'snopix-danger-soft': 'var(--snopix-danger-soft)',
